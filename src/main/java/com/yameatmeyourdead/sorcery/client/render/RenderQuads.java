package com.yameatmeyourdead.sorcery.client.render;
...
public class RenderQuads {
    ...
    //        missing texture
    public static final ResourceLocation MBE21_CUBE_FACE_TEXTURE = new ResourceLocation("sorcery:textures/blocks/bitch.png");
  
    public static void renderCubeUsingQuads(ArcaneCircleTileEntity arcaneCircleTileEntity, float partialTicks, MatrixStack matrixStack, IRenderTypeBuffer renderBuffers,
    ...
    private static void drawCubeQuads(MatrixStack matrixStack, IRenderTypeBuffer renderBuffer,
      ...
      IVertexBuilder vertexBuilderBlockQuads = renderBuffer.getBuffer(RenderType.entitySolid(MBE21_CUBE_FACE_TEXTURE));
